...
procedure afficherTexte2();                       //quitter le jeu
begin
...
procedure afficherTexte3();                        //titre
begin
  writeln('Création d''une nouvelle partie');
end;


procedure afficherTexte4();                        //selection nom
begin
...
procedure afficherTexte19();                           // nom de l'île
begin
  writeln('Bienvenue sur : Dayfell Cay');
end;


procedure afficherTexte20(p:Personnage);                  // nom du joueur
begin
  writeln('Nom du joueur  :   ',getNom(p));                         //2 espaces
end;


procedure afficherTexte21();                        // quantité d'or
begin
  writeln('Or             :   ', getGold);          //13 espaces
end;


procedure afficherTexte22();                       // titre "description"
begin
  writeln('Description');
end;
...
procedure afficherTexte23();
begin
  writeln('Nom de l''île          :');                //10 espaces
end;


procedure afficherTexte24();
begin
  writeln('Propriétaire          :');                //10 espaces
end;

procedure afficherTexte25();
begin
  writeln('Fertilité de l''île    :');                //10 espaces
end;
...
procedure afficherTexte28();                          // nom de l'île
begin
  writeln('Dayfell Cay');
end;


procedure afficherTexte29(p:Personnage);               // nom du propriétaire
begin
  writeln(getNom(p));
end;

procedure afficherTexte30();                      // taux de fertilité
begin
...
procedure afficherTexte31();                     // titre population
begin
...
procedure afficherTexte32();
begin
  writeln('Nombre de colons       :');                 //7 espaces
end;


procedure afficherTexte33();
begin
  writeln('Nombre de citoyens     :');                 //5 espaces
end;

procedure afficherTexte34();
begin
  writeln('Nombre de soldats      :');                 //6 espaces
end;

procedure afficherTexte35();                      // nombre de colons
begin
...
procedure afficherTexte36();
begin
  writeln('(Chaque colon consomme 1 poisson par jour)');         // consommations colons
end;

procedure afficherTexte37();                      // nombre de colons
begin
  writeln(getCitoyens);
end;
...
procedure afficherTexte38();
begin
  writeln('(Chaque citoyen consomme 1 poisson, 2 tissus et 1 pomme par jour)');         // consommations citoyens
end;

procedure afficherTexte39();                      // nombre de soldats
begin
  writeln(getSoldat);
end;
...
procedure afficherTexte42();                         // titre ressources
begin
...
procedure afficherTexte43();
begin
  writeln('Quantité de poissons          :');              //10 espaces
end;


procedure afficherTexte44();
begin
  writeln('Quantité de bois              :');              //14 espaces
end;


procedure afficherTexte45();
begin
  writeln('Quantité d''outils             :');              //13 espaces
end;


procedure afficherTexte46();
begin
  writeln('Quantité de laines            :');              //13 espaces
end;


procedure afficherTexte47();
begin
  writeln('Quantité de tissus            :');              //13 espaces
end;


procedure afficherTexte48();
begin
  writeln('Quantité de pommes            :');              //13 espaces
end;

procedure afficherTexte49();
begin
  writeln('Quantité de rhums             :');              //12 espaces
end;

procedure afficherTexte50();
begin
  writeln('Quantité de charbons          :');              //11 espaces
end;

procedure afficherTexte51();
begin
  writeln('Quantité de fers              :');              //15 espaces
end;


procedure afficherTexte52();                         //nb poissons
begin
  writeln(getPoissons,'/',getStock);
end;

procedure afficherTexte53();                         //nb bois
begin
  writeln(getBois,'/',getStock);
end;

procedure afficherTexte54();                         //nb outils
begin
  writeln(getOutils,'/',getStock);
end;

procedure afficherTexte55();                         //nb laine
begin
  writeln(getLaine,'/',getStock);
end;

procedure afficherTexte56();                         //nb tissu
begin
  writeln(getTissu,'/',getStock);
end;

procedure afficherTexte57();                         //nb charbon
begin
  writeln(getPomme,'/',getStock);
end;

procedure afficherTexte58();                         //nb fer
begin
  writeln(getRhum,'/',getStock);
end;

procedure afficherTexte59();                         //nb charbon
begin
  writeln(getCharbon,'/',getStock);
end;

procedure afficherTexte60();                         //nb fer
begin
...
procedure afficherTexte61();                         //changer de jour
begin
  writeln('Tour suivant (Tapez 1 puis entrée)');
end;


procedure afficherTexte62();                        // aller à la page "gestion batiments"
begin
  writeln('Gestion des batiments (Tapez 2 puis entrée)');
end;


procedure afficherTexte63();                     // quitter le jeu
begin
...
procedure afficherTexte78();
begin
  writeln('Maison de Colons            :');                //12 espaces
end;
...
procedure afficherTexte80();
begin
  writeln('Maison de Citoyens          :');                //10 espaces
end;
...
procedure afficherTexte82();
begin
  writeln('Caverne de soldat           :');              //11 espaces
end;
...
procedure afficherTexte85();
begin
  writeln('Centre-ville                :');                 // 16 espaces
end;


procedure afficherTexte86();
begin
  writeln('Chapelle                    :');                 // 20 espaces
end;
...
procedure afficherTexte90();
begin
  writeln('Cabane de bucherons          :');              //10 espaces
end;


procedure afficherTexte91();
begin
  writeln('Cabane de pêcheurs           :');              //12 espaces
end;


procedure afficherTexte92();
begin
  writeln('Bergerie                     :');              //21 espaces
end;


procedure afficherTexte93();
begin
  writeln('Atelier de tisserands        :');              //8 espaces
end;

procedure afficherTexte94();
begin
  writeln('Entrepot                     :');              //22 espaces
end;


procedure afficherTexte95();
begin
  writeln('Scierie                       :');              //23 espaces
end;

procedure afficherTexte96();
begin
  writeln('Verger                        :');              //24 espaces
end;

procedure afficherTexte97();
begin
  writeln('Distillerie                   :');              //19 espaces
end;

procedure afficherTexte98();
begin
  writeln('Mine                          :');              //26 espaces
end;

procedure afficherTexte99();
begin
  writeln('Fonderie                      :');              //22 espaces
end;

procedure afficherTexte100();
begin
  writeln('Outilleur                     :');              //21 espaces
end;
