...
procedure initialisation1();               //difficulté très facile
begin
  gold := 15000;
  bois :=50;
  poissons:=50;
...
procedure initialisation2();                  //difficulté facile
begin
  gold := 10000;
  bois :=40;
  poissons:=40;
...
procedure initialisation3();                 //difficulté moyenne
begin
  gold := 7500;
  bois :=30;
  poissons:=25;
...
procedure initialisation4();                    //difficulté difficile
begin
  gold := 5000;
  bois :=20;
  poissons:=15;
