...
begin
  ...
  deplacerCurseurXY(86,52);               //quitter le jeu
  afficherTexte18();
...
begin
  ...
  deplacerCurseurXY(55,15);          // textes Construire habitations
  afficherTexte77();
  deplacerCurseurXY(20,19);
  afficherTexte78();
  deplacerCurseurXY(20,21);
  ...
  deplacerCurseurXY(45,19);         // données Construire habitations
  afficherTexte115();
  deplacerCurseurXY(45,21);
  afficherTexte116();
  deplacerCurseurXY(45,23);
  afficherTexte117();
  ...
  deplacerCurseurXY(29,48);       // textes choix de l'action
  afficherTexte131();
  ...
  deplacerCurseurXY(37,52);       // Quitter le jeu
  afficherTexte132();

  deplacerCurseurXY(49,11);         // emplacement réponse
...
begin
  ...
  deplacerCurseurXY(18,12);        // scénario du marchand
  afficherTexte133();
  ...
  deplacerCurseurXY(150,21);        // textes Acheter
  afficherTexte138();
  deplacerCurseurXY(122,24);
  afficherTexte139();
  ...
  deplacerCurseurXY(150,38);        // textes Vendre
  afficherTexte144();
  deplacerCurseurXY(122,41);
  afficherTexte145();
  ...
  deplacerCurseurXY(30,52);         // Arrêter de marchander
  afficherTexte154();

  readln(rep);
     case(rep)of
       1: begin                         //acheter un poisson
            aPoisson();
            readln;
            ecran6(p);
          end;

       2: begin                         // acheter du bois
            aBois();
            readln;
            ecran6(p);
          end;

       3: begin                         // acheter un outil
             aOutil();
             readln;
             ecran6(p);
          end;

       4: begin                        // acheter une laine
            aLaine();
            readln;
            ecran6(p);
          end;
       ...
       6: begin                        // vendre un poisson
            vPoisson();
            readln;
            ecran6(p);
          end;

       7: begin                        // vendre du bois
            vBois();
            readln;
            ecran6(p);
          end;

       8: begin                        // vendre un outil
            vOutil();
            readln;
            ecran6(p);
          end;

       9: begin                        // vendre une laine
            vLaine();
            readln;
            ecran6(p);
          end;
      ...
      11: begin                        // vendre du rhum
            vRhum();
            readln;
            ecran6(p);
          end;

      12: begin                    //dessine l'ecran de menu (fin du tour)
            Ecran3(p);
          end;
...
begin
  ...
  deplacerCurseurXY(18,30);       // possibilité d'acheter des soldats
  afficherTexte162();
  ...
  readln(rep);
     case(rep)of
      'o':begin
          if (getCaverne>0) then                 //si toutes les conditions sont réunies....
              if getGold()>300 then
                begin                            //acheter un soldat
                  setGold(getGold()-300);
                  setSoldat(getSoldat()+1);
                ...
                begin
                  deplacerCurseurXY(120,30);      //message d'erreur
                  afficherTexte152();
                end
          else
            begin
  ...
  readln(a);                                       //choix du nombre de soldats à envoyer au combat
  setSoldatVeut(a);
  if (getSoldatVeut()>getSoldat()) then            //si le nombre choisi dépasse le nombre de soldats disponibles...
      begin
        deplacerCurseurXY(18,36);
        afficherTexte164();                        //message d'erreur
        readln();
        Ecran7(p);
      end
  else                                            //sinon...
      begin
         ...
         deplacerCurseurXY(18,36);
         afficherTexte165();                     // début du combat
      end;
  readln;
  deplacerCurseurXY(18,38);
  afficherTexte166();

  if getSoldatCombat>=getPilleur then            //cas où le combat est gagné
    begin
    ...
    begin                                         //cas où le combat est perdu
       deplacerCurseurXY(18,42);
       afficherTexte169();
       ...
       if (getBois()> 20) then                     //perte de ressources
         setBois(getBois-20)
       else
         setBois(0);
    ...
    readln();
    setPilleur(getPilleur*2);               //la quantité de pilleurs double pour la prochaine attaque
    ecran3(p);                              //dessine l'écran de menu (fin du tour)
